...
res = rq.get('http://fastapi:8000/main_plot?dname=co2')
...
res = rq.get('http://fastapi:8000/main_plot?dname=air_passengers')
st.image(res.content)
l, link = st.columns([0.6, 0.4])
...
res = rq.get('http://fastapi:8000/main_plot?dname=bitcoin')
st.image(res.content)
l, link = st.columns([0.6, 0.4])
...
res = rq.get('http://fastapi:8000/main_plot?dname=bike')
st.image(res.content)
l, link = st.columns([0.6, 0.4])
